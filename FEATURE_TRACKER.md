...
| DS-003 | v0.1 Recording Core | Add post-merge tracker sync rule | in_review | Define how FEATURE_TRACKER.md is synchronized after PR merges. |
...
| DS-006 | v0.1 Recording Core | Initial ADR structure | planned | ADR index and starter decision records. |
